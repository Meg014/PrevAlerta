...
// Preserva a cobertura dos perfis existentes; testes de acesso local habilitam o modo explicitamente.
...
(new Migrator())->run();
// Novas colunas precisam estar visíveis mesmo após testes de uma versão anterior.
