...
return [
    // Uso local no PC: identidade PCM automática, sem alterar os serviços de negócio.
    'LocalAccess' => [
        'enabled' => filter_var(env('PREV_LOCAL_ACCESS', true), FILTER_VALIDATE_BOOLEAN),
        'allowRemote' => filter_var(env('PREV_ALLOW_REMOTE_ACCESS', false), FILTER_VALIDATE_BOOLEAN),
    ],
    /*
     * Debug Level:
     *
    ...
    'Session' => [
        'defaults' => 'cake',
        'timeout' => 120,
        'ini' => ['session.cookie_httponly' => true, 'session.cookie_samesite' => 'Lax'],
    ],
